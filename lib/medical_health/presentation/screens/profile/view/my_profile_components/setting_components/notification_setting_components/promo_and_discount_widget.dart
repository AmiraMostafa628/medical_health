...
class PromoAndDiscountWidget extends StatelessWidget {
  const PromoAndDiscountWidget({super.key});
          ...
          return Row(
            ...
            children: [
              ...
              FlutterSwitch(
                ...
                height: 30.0,
                toggleSize: 20.0,
                value: state.promoAndDiscountSwitchVal,
                borderRadius: 30.0,
                padding: 4.0,
                activeColor: state.promoAndDiscountSwitchVal
                    ? ColorManager.primaryColor
                    : ColorManager.lightPrimaryColor,
                inactiveColor: state.promoAndDiscountSwitchVal
                    ? ColorManager.primaryColor
                    : ColorManager.lightPrimaryColor,
