...
class SoundCallWidget extends StatelessWidget {
  const SoundCallWidget({super.key});
          ...
          return Row(
            ...
            children: [
              ...
              FlutterSwitch(
                ...
                height: 30.0,
                toggleSize: 20.0,
                value: state.soundCallSwitchVal,
                borderRadius: 30.0,
                padding: 4.0,
                activeColor: state.soundCallSwitchVal
                    ? ColorManager.primaryColor
                    : ColorManager.lightPrimaryColor,
                inactiveColor: state.soundCallSwitchVal
                    ? ColorManager.primaryColor
                    : ColorManager.lightPrimaryColor,
